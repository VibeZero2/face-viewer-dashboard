#!/bin/bash
# Script to help deploy the Face Viewer Dashboard on Render
...
# Create a simple Flask app file directly in the deployment
echo "=== Creating simple Flask app ==="
...
echo "=== Starting Gunicorn with simple_app.py ==="
