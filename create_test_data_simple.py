"""
Simple test data generator for Face Viewer Dashboard
...
def create_test_participant_data(num_participants=5, responses_per_participant=10):
    ...
    # Face versions based on the Face Half Viewer and Face Analysis Tool
    ...
    for p_idx in range(1, num_participants + 1):
        ...
        with open(filepath, 'w', newline='', encoding='utf-8') as f:
            # Define CSV columns based on the Face Half Viewer and Face Analysis Tool
            fieldnames = [
                'Participant ID', 'Face', 'Version', 'Trust', 'Emotion',
                'Masculinity', 'Femininity', 'Symmetry', 'FaceVersion', 'FaceID', 'Timestamp'
            ]
            ...
            for r_idx in range(1, responses_per_participant + 1):
                ...
                symmetry = round(random.uniform(1.0, 7.0), 1)
...
if __name__ == "__main__":
    ...
    try:
        ...
        create_test_participant_data(num_participants=10, responses_per_participant=20)
